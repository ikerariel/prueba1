...
<html>
    ...
    <head>
        ...
        <script src="validador/sRecepcionvalidad.js"></script> 
    ...
    <body>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="col-md-9" id="botonesRecepcion">
                    <a id="btnNuevoRecepcion"  class="btn btn-lg btn-success" style=" font-weight: bold"   data-toggle="modal"
                       >Nuevo </a>
                    <a id="btnConfirmarRecepcion" class="btn btn-lg btn-warning glyphicon glyphicon-ok"  style=" font-weight: bold" title="Confirmar" ></a>
                    <a id="btnRevertirRecepcion" class="btn btn-lg btn-danger glyphicon glyphicon-minus-sign" style=" font-weight: bold" title="Revertir Confirmacion " ></a>
                    <a id="btnInformeRecepcion" class="btn btn-lg btn-primary glyphicon glyphicon-print" style=" font-weight: bold" title="Visualizar Reporte " ></a>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">PLANILLA DE RECEPCIÓN DE EQUIPOS</div>

                    <div class="">
                        <div class="input-group  input-sm">
                            <span class="input-group-addon" style=" font-weight: bold">Nro. Registro*</span>
                            <input id="nroRecepcion" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="">
                            <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                            <input id="estadoRecepcion" type="text" style="" class="form-control" disabled="" placeholder="Estado">
                        </div>
                    </div>
                    ...
                    <div class="">
                        <div class="input-group input-sm">
                            ...
                            <input id="filtroRecepcion" type="text" style="text-transform: uppercase; font-weight: bold" 
                    ...
                    <div class="panel-body">
                        ...
                        <div id="scrollPlanilla" class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table input-md" id="mitablaRecepcion" >
        ...
        <div class="modal fade" id="ventanaRecepcion">
            <div class="modal-dialog" style="width: 80%;">
                <div class="modal-content">
                    ...
                    <div class="modal-header" >
                        <a class="btn btn-lg btn-primary col-md-1" style="display: none"  id="btnguardarRecepcion" title=""  >Guardar</a>
                        <a class="btn btn-lg btn-success col-md-1" style="display: none" id="btntmodificarRecepcion" title=""  >Guardar</a>
                        <a class="close  btn btn-lg btn-danger glyphicon glyphicon-off" id="btnclose" data-dismiss="modal" aria-hidden="true" title="Salir"></a>
                    </div>
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <div class="panel-footer" style="font-weight: bold">NUEVA RECEPCIÓN</div>
                            <br> 
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        <input disabled="" id="codigoRecepcion" style="text-transform: uppercase; font-weight: bold; font-size: 12pt" 
                                               name="codigo" type="text" placeholder="Codigo" class="form-control input-sm ">
                                    </div>

                                    <label class="col-md-1 col-sm-pull-0 control-label">Fecha</label>  
                                    <div class="col-md-2 col-sm-pull-0">
                                        <input disabled id="fechaRecepcion" type="datetime" style="text-transform: uppercase; font-weight: bold;font-size: 12pt"
                    ...
                    <DIV class="modal-body">
                        <form class="form-horizontal" id="miForm" >
                            <div class="form-group" >
                                ...
                                <div class="col-md-1">
                                    <input  id="clienteCV" type="text" style="font-weight: bold;font-size: 12pt"
                                            class="form-control input-sm ">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-md-2">
                                    <input  class="form-control " id="telefonoModalRecepcion"style="font-weight: bold;font-size: 10pt" type="text">
                                </div>
                                <label class="control-label col-md-2">Direccion:</label>
                                <div class="col-md-6">
                                    <input class="form-control " maxlength="80" id="direccioneModal" style="font-weight: bold;font-size: 10pt"type="text">
                                </div>
                            </div>
                            <div class="form-group" >
                                <div class="col-md-12">
                                    <a class="btn btn-lg btn-default btn-block " id="tbnsavecliente"  >
