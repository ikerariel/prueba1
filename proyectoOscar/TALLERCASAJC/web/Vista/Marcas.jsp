<%-- 
    Document   : Marcas
    Created on : 25/07/2018, 11:17:21 AM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../validador/Marcasvalidad.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR MARCAS</div>
                    ...
                    <div class="table-responsive" > 
                        <div class="headercontainer" >
                            <div class="tablecontainer">
                                <table class=" table-striped table-bordered table-hover table input-md" id="miTablaMarcas" onclick="recuperar()">
                                    <thead>
                                        <tr>
                                            <th><div>ID</div></th>
                                    ...
                                    <tbody class="buscarMarcas"></tbody>
                                </table>
                            </div>
                        </div>     
                    </div>
                    ...
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input disabled="" type="" id="codmarca" style="text-transform: uppercase; font-weight: bold; font-size: 12pt;
