<%-- 
    Document   : Sucursales
    Created on : 30/07/2018, 11:00:05 AM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../validador/Sucursalesvalidad.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR SUCURSALES</div>
                    
                    <div class="table-responsive" > 
                        <div class="headercontainer" >
                            <div class="tablecontainer">
                                <table class=" table-striped table-bordered table-hover table input-md" id="miTablaSucursales" onclick="recuperar()">
                                    <thead>
                                        <tr>
                                            <th><div>ID</div></th>
                                    ...
                                    <tbody class="buscarSucursales"></tbody>
                                </table>
                            </div>
                        </div>     
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" id="filtrarSucursales" placeholder="Ingrese Descripcion a Buscar"
                    ...
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input id="descrisucursal"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 10pt;
                                ...
                                <div class="col-md-3" id="comboBarrios">
                                    <select id="idbarrio" type="text" style="text-transform: uppercase; font-weight: bold;font-size: 10pt;
                                            background-color: #d9edf7" class="form-control input-sm"></select>
                                </div>
                            </div>
                        </div> 
