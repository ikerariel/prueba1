            ...
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="col-md-9" id="botonesFacturasCompras">
                    <a id="btnNuevo" href="#ventanaFacturasCompras" class="btn btn-lg btn-success" style=" font-weight: bold"  title="Nuevo Factura Compras" data-toggle="modal"
                       onclick="getcodigoCompras(); fechaactualCompras(); MostrarEstados(); MostrarUsuarios(); MostrarSucursales()">Nuevo </a>
                    <a id="btnModificar" class="btn btn-lg btn-info" style=" font-weight: bold" title="Modificar Factuta Compras" data-toggle="modal" onclick="recuperarDetFacturaCompras()">Recuperar </a>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="">
                        <div class="input-group  input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">PEDIDOS Nro*</span>
                                <input id="nrofacturaP" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero de Pedido">
                                <span class="input-group-addon" style=" font-weight: bold" >ESTADOS*</span>
                    ...
                    <div class="">
                            <div class="input-group input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">BUSCADOR</span>
            ...
            <div class="modal-dialog" style="width: 1300px;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <a class="btn btn-lg btn-danger col-md-1"  id="btnGuardar" title="" onclick="InsertarFacturasCompras()" >Guardar</a>
                        <a class="btn btn-lg btn-danger col-md-1"  id="btnGuardarModificado" title="" onclick="ModificarDetOrdenComprass()" >Modificar</a>
