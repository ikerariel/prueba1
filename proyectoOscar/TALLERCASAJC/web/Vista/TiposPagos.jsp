<%-- 
    Document   : TiposPagos
    Created on : 25/08/2019, 08:54:03 PM
    Author     : Oscar
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../validador/TiposPagosvalidad.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR TIPOS PAGOS</div>
                    ...
                    <div class="table-responsive" > 
                        <div class="headercontainer" >
                            <div class="tablecontainer">
                                <table class=" table-striped table-bordered table-hover table input-md" id="miTablaTiposPagos" onclick="recuperar()">
                                    <thead>
                                        <tr>
                                            <th><div>ID</div></th>
                                    ...
                                    <tbody class="buscarTiposPagos"></tbody>
                                </table>
                            </div>
                        </div>     
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" id="filtrarTiposPagos" placeholder="Ingrese Descripcion a Buscar"
                    ...
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="descri"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
